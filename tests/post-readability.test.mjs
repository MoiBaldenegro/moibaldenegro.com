...
//   REQ-40-11 — solo tokens existentes: tokens.css permanece en 87 líneas
...
test('REQ-40-11: tokens.css conserva 87 líneas sin tokens de post/reading/font-size', () => {
  const tokens = readTokens();
  const lineCount = countLines(tokens);
  assert.equal(lineCount, 87, `tokens.css tiene ${lineCount} líneas y debe conservar 87 (REQ-40-11, REQ-26-07/39-09)`);
