...
Una vez comprendida la abstracción, pasemos al **encapsulamiento**. Es crucial no confundirlo directamente con el mecanismo de modificadores de acceso (`public`, `private`, `protected`) de la Programación Orientada a Objetos, aunque estén relacionados.

El principio de encapsulamiento en diseño va un paso más allá: **consiste en ocultar la complejidad y los detalles internos de implementación**.
...
La modularización consiste en subdividir un problema complejo y de gran escala en partes más pequeñas, independientes y manejables.

Esto aporta ventajas estratégicas fundamentales al desarrollo:
