...
9. **No marques `done` tú mismo.** Solo lo marcas cuando exista
   ...
   Máximo 3 rondas; si sigue rechazando → marca `status: "blocked"` en
   `feature_list.json` y reporta.
...
- El informe `progress/impl_<feature>.md` documenta la evidencia del ciclo
